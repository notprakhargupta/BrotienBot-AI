          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center relative">
            ...
            <div className="lg:col-span-7 space-y-8 relative">
              <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold tracking-tight">
                ...
                <div>
                  <span className="text-primary">Starts with a question:</span>
                </div>
                <div className="pt-2">
                  <span className="text-foreground">‘Yo Brotien Bot,</span>
                </div>
                <div className="pt-2">
                  <span className="text-foreground">what’s </span>
                  <span className="text-primary"> the plan?’</span>
                </div>
              </h1>
              ...
              Talk to our AI assistant and get custom diet and workout plans made just for you—designed around your body, goals, injuries, and allergies.
              </p>
              ...
              <div className="flex flex-col sm:flex-row gap-4 pt-6">
                ...
                >
                  ...
                  Get Your AI-Powered Customized Plan – Free!
